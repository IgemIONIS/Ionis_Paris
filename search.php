...
<body>
	...
	<div class="navigation">
		<div class="inner">
			<div class="container">
				...
				<div class="right">
					<a href="soumission.php" class="submissionbutton">Submission</a>
	...
	<form action="search.php" method="POST" name="formulaire " oninput="x.value=parseInt(depth.value)">
		<div class="fromContainer">
			...
			<br>
			<br>
			<label for="idchoix" class="sendtext">Choose the target bacteria:</label>
			<br>
			<br>
			<select name="bacterie[]" class="sendselect">
				<option value=""></option>
			...
			<input type='submit' class="sendBacteriaName" name="envoyer"value="Submit"/>
		</div>
	</form>
</div>
